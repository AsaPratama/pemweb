...
if(isset($_POST['register'])) {
  ...
  //query input user
  $query = "INSERT INTO tbuser (idUser, username, password)VALUES(NULL,'$username','$password')";
      ...
      <div class="position-absolute top-50 start-50 translate-middle">
        <div class="container-fluid text-center">
          <div class="card" style="padding:20px;">
            <h1 class="display-6" style="padding-bottom: 30px;">Register</h1>
            ...
            <input type="submit" name="register" class="btn btn-success" style="padding-left: 80px; padding-right: 80px;" placeholder="login">
